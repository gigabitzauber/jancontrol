...
```bash
java -jar jancontrol-0.7.0-SNAPSHOT.jar [options] <config-file>
```
...
```bash
java -jar jancontrol-0.7.0-SNAPSHOT.jar -v <config-file>
```
...
```bash
java -jar jancontrol-0.7.0-SNAPSHOT.jar -w <config-file>
```
