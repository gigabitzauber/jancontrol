...
```bash
java -jar jancontrol-0.6.1-SNAPSHOT.jar [options] <config-file>
```
...
```bash
java -jar jancontrol-0.6.1-SNAPSHOT.jar -v <config-file>
```
...
```bash
java -jar jancontrol-0.6.1-SNAPSHOT.jar -w <config-file>
```
