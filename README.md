...
```bash
java -jar jancontrol-0.6.2-SNAPSHOT.jar [options] <config-file>
```
...
```bash
java -jar jancontrol-0.6.2-SNAPSHOT.jar -v <config-file>
```
...
```bash
java -jar jancontrol-0.6.2-SNAPSHOT.jar -w <config-file>
```
